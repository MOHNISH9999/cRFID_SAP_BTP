...
import com.company.crfid_sap_btp.databinding.FragmentIntslocvalidsetDetailBinding
...
class IntSlocValidSetDetailFragment : InterfacedFragment<IntSlocValid, FragmentIntslocvalidsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, intSlocValidEntity: IntSlocValid) {
        if (intSlocValidEntity.getOptionalValue(IntSlocValid.rsnum) != null && !intSlocValidEntity.getOptionalValue(IntSlocValid.rsnum).toString().isEmpty()) {
