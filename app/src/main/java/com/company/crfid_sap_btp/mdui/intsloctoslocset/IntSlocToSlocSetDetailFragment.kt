...
import com.company.crfid_sap_btp.databinding.FragmentIntsloctoslocsetDetailBinding
...
class IntSlocToSlocSetDetailFragment : InterfacedFragment<IntSlocToSloc, FragmentIntsloctoslocsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, intSlocToSlocEntity: IntSlocToSloc) {
        if (intSlocToSlocEntity.getOptionalValue(IntSlocToSloc.rsnum) != null && !intSlocToSlocEntity.getOptionalValue(IntSlocToSloc.rsnum).toString().isEmpty()) {
