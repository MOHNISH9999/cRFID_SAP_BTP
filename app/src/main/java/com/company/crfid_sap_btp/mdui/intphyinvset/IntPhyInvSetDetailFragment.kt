...
import com.company.crfid_sap_btp.databinding.FragmentIntphyinvsetDetailBinding
...
class IntPhyInvSetDetailFragment : InterfacedFragment<IntPhyInv, FragmentIntphyinvsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, intPhyInvEntity: IntPhyInv) {
        if (intPhyInvEntity.getOptionalValue(IntPhyInv.lgort) != null && !intPhyInvEntity.getOptionalValue(IntPhyInv.lgort).toString().isEmpty()) {
