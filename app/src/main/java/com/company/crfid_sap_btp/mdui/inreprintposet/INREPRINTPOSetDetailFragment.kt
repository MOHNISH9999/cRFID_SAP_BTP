...
import com.company.crfid_sap_btp.databinding.FragmentInreprintposetDetailBinding
...
class INREPRINTPOSetDetailFragment : InterfacedFragment<InReprintPo, FragmentInreprintposetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, inReprintPoEntity: InReprintPo) {
        if (inReprintPoEntity.getOptionalValue(InReprintPo.mcod1) != null && !inReprintPoEntity.getOptionalValue(InReprintPo.mcod1).toString().isEmpty()) {
