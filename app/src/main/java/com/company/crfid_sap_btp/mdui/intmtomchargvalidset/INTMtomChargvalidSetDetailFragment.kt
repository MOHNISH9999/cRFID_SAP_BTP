...
import com.company.crfid_sap_btp.databinding.FragmentIntmtomchargvalidsetDetailBinding
...
class INTMtomChargvalidSetDetailFragment : InterfacedFragment<INTMtomChargvalid, FragmentIntmtomchargvalidsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, intMtomChargvalidEntity: INTMtomChargvalid) {
        if (intMtomChargvalidEntity.getOptionalValue(INTMtomChargvalid.maktx) != null && !intMtomChargvalidEntity.getOptionalValue(INTMtomChargvalid.maktx).toString().isEmpty()) {
