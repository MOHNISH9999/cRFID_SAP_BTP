...
import com.company.crfid_sap_btp.databinding.FragmentOutgiscrapsetDetailBinding
...
class OUTGISCRAPSetDetailFragment : InterfacedFragment<OutGiScrap, FragmentOutgiscrapsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, outGiScrapEntity: OutGiScrap) {
        if (outGiScrapEntity.getOptionalValue(OutGiScrap.lgort) != null && !outGiScrapEntity.getOptionalValue(OutGiScrap.lgort).toString().isEmpty()) {
