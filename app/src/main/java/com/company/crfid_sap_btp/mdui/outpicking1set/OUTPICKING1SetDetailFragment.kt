...
import com.company.crfid_sap_btp.databinding.FragmentOutpicking1setDetailBinding
...
class OUTPICKING1SetDetailFragment : InterfacedFragment<OutPicking1, FragmentOutpicking1setDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, outPicking1Entity: OutPicking1) {
        if (outPicking1Entity.getOptionalValue(OutPicking1.name1) != null && !outPicking1Entity.getOptionalValue(OutPicking1.name1).toString().isEmpty()) {
