...
import com.company.crfid_sap_btp.databinding.FragmentMatdetailssetDetailBinding
...
class MatDetailsSetDetailFragment : InterfacedFragment<MatDetails, FragmentMatdetailssetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, matDetailsEntity: MatDetails) {
        if (matDetailsEntity.getOptionalValue(MatDetails.tagId) != null && !matDetailsEntity.getOptionalValue(MatDetails.tagId).toString().isEmpty()) {
