...
import com.company.crfid_sap_btp.databinding.FragmentInprintpoitemsetDetailBinding
...
class INPRINTPOITEMSetDetailFragment : InterfacedFragment<InPrintPoItem, FragmentInprintpoitemsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, inPrintPoItemEntity: InPrintPoItem) {
        if (inPrintPoItemEntity.getOptionalValue(InPrintPoItem.ebeln) != null && !inPrintPoItemEntity.getOptionalValue(InPrintPoItem.ebeln).toString().isEmpty()) {
