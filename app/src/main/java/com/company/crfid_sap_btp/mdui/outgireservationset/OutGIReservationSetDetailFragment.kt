...
import com.company.crfid_sap_btp.databinding.FragmentOutgireservationsetDetailBinding
...
class OutGIReservationSetDetailFragment : InterfacedFragment<OutGIReservation, FragmentOutgireservationsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, outGIReservationEntity: OutGIReservation) {
        if (outGIReservationEntity.getOptionalValue(OutGIReservation.maktx) != null && !outGIReservationEntity.getOptionalValue(OutGIReservation.maktx).toString().isEmpty()) {
