...
import com.company.crfid_sap_btp.databinding.FragmentIntmattomatsesetDetailBinding
...
class INTMattomatSeSetDetailFragment : InterfacedFragment<INTMattomatSe, FragmentIntmattomatsesetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, intMattomatSeEntity: INTMattomatSe) {
        if (intMattomatSeEntity.getOptionalValue(INTMattomatSe.mtart) != null && !intMattomatSeEntity.getOptionalValue(INTMattomatSe.mtart).toString().isEmpty()) {
