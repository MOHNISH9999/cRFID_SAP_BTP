package com.company.crfid_sap_btp.viewmodel.matdetails
...
/*
 * Represents View model for MatDetails
 *
 ...
 */
class MatDetailsViewModel(application: Application): EntityViewModel<MatDetails>(application, EntitySets.matDetailsSet, MatDetails.tagId) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<MatDetails>(application, EntitySets.matDetailsSet, MatDetails.tagId, navigationPropertyName, entityData)
    }
}
