package com.company.crfid_sap_btp.viewmodel.intphyinv
...
/*
 * Represents View model for IntPhyInv
 *
 ...
 */
class IntPhyInvViewModel(application: Application): EntityViewModel<IntPhyInv>(application, EntitySets.intPhyInvSet, IntPhyInv.lgort) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IntPhyInv>(application, EntitySets.intPhyInvSet, IntPhyInv.lgort, navigationPropertyName, entityData)
    }
}
