package com.company.crfid_sap_btp.viewmodel.intmattomatse
...
/*
 * Represents View model for INTMattomatSe
 *
 ...
 */
class INTMattomatSeViewModel(application: Application): EntityViewModel<INTMattomatSe>(application, EntitySets.intMattomatSeSet, INTMattomatSe.mtart) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<INTMattomatSe>(application, EntitySets.intMattomatSeSet, INTMattomatSe.mtart, navigationPropertyName, entityData)
    }
}
