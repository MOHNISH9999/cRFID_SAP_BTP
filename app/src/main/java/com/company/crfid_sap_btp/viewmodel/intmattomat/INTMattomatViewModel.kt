package com.company.crfid_sap_btp.viewmodel.intmattomat
...
/*
 * Represents View model for INTMattomat
 *
 ...
 */
class INTMattomatViewModel(application: Application): EntityViewModel<INTMattomat>(application, EntitySets.intMattomatSet, INTMattomat.maktx) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<INTMattomat>(application, EntitySets.intMattomatSet, INTMattomat.maktx, navigationPropertyName, entityData)
    }
}
