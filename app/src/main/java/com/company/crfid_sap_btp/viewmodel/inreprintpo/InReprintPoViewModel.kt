package com.company.crfid_sap_btp.viewmodel.inreprintpo
...
/*
 * Represents View model for InReprintPo
 *
 ...
 */
class InReprintPoViewModel(application: Application): EntityViewModel<InReprintPo>(application, EntitySets.inREPRINTPOSet, InReprintPo.mcod1) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<InReprintPo>(application, EntitySets.inREPRINTPOSet, InReprintPo.mcod1, navigationPropertyName, entityData)
    }
}
