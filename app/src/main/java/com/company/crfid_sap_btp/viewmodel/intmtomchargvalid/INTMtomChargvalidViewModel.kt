package com.company.crfid_sap_btp.viewmodel.intmtomchargvalid
...
/*
 * Represents View model for INTMtomChargvalid
 *
 ...
 */
class INTMtomChargvalidViewModel(application: Application): EntityViewModel<INTMtomChargvalid>(application, EntitySets.intMtomChargvalidSet, INTMtomChargvalid.maktx) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<INTMtomChargvalid>(application, EntitySets.intMtomChargvalidSet, INTMtomChargvalid.maktx, navigationPropertyName, entityData)
    }
}
