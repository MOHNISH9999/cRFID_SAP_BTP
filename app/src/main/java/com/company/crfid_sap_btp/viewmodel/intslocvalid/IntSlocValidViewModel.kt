package com.company.crfid_sap_btp.viewmodel.intslocvalid
...
/*
 * Represents View model for IntSlocValid
 *
 ...
 */
class IntSlocValidViewModel(application: Application): EntityViewModel<IntSlocValid>(application, EntitySets.intSlocValidSet, IntSlocValid.rsnum) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IntSlocValid>(application, EntitySets.intSlocValidSet, IntSlocValid.rsnum, navigationPropertyName, entityData)
    }
}
