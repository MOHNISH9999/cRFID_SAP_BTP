package com.company.crfid_sap_btp.viewmodel.intphyvalid
...
/*
 * Represents View model for IntPhyValid
 *
 ...
 */
class IntPhyValidViewModel(application: Application): EntityViewModel<IntPhyValid>(application, EntitySets.intPhyValidSet, IntPhyValid.werks) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IntPhyValid>(application, EntitySets.intPhyValidSet, IntPhyValid.werks, navigationPropertyName, entityData)
    }
}
