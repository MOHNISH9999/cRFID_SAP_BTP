package com.company.crfid_sap_btp.viewmodel.outgireservation
...
/*
 * Represents View model for OutGIReservation
 *
 ...
 */
class OutGIReservationViewModel(application: Application): EntityViewModel<OutGIReservation>(application, EntitySets.outGIReservationSet, OutGIReservation.maktx) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<OutGIReservation>(application, EntitySets.outGIReservationSet, OutGIReservation.maktx, navigationPropertyName, entityData)
    }
}
