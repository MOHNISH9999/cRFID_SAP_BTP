package com.company.crfid_sap_btp.viewmodel.loginsrv
...
/*
 * Represents View model for LoginSrv
 *
 ...
 */
class LoginSrvViewModel(application: Application): EntityViewModel<LoginSrv>(application, EntitySets.loginSrvSet, LoginSrv.compCode) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<LoginSrv>(application, EntitySets.loginSrvSet, LoginSrv.compCode, navigationPropertyName, entityData)
    }
}
