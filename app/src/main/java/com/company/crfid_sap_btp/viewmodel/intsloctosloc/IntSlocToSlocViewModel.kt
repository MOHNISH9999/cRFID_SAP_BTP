package com.company.crfid_sap_btp.viewmodel.intsloctosloc
...
/*
 * Represents View model for IntSlocToSloc
 *
 ...
 */
class IntSlocToSlocViewModel(application: Application): EntityViewModel<IntSlocToSloc>(application, EntitySets.intSlocToSlocSet, IntSlocToSloc.rsnum) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IntSlocToSloc>(application, EntitySets.intSlocToSlocSet, IntSlocToSloc.rsnum, navigationPropertyName, entityData)
    }
}
