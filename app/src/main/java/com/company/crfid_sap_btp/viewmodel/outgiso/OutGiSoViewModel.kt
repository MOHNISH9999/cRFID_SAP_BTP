package com.company.crfid_sap_btp.viewmodel.outgiso
...
/*
 * Represents View model for OutGiSo
 *
 ...
 */
class OutGiSoViewModel(application: Application): EntityViewModel<OutGiSo>(application, EntitySets.outGISOSet, OutGiSo.vbtyp) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<OutGiSo>(application, EntitySets.outGISOSet, OutGiSo.vbtyp, navigationPropertyName, entityData)
    }
}
