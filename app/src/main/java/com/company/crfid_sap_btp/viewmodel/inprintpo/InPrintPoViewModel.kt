package com.company.crfid_sap_btp.viewmodel.inprintpo
...
/*
 * Represents View model for InPrintPo
 *
 ...
 */
class InPrintPoViewModel(application: Application): EntityViewModel<InPrintPo>(application, EntitySets.inPRINTPOSet, InPrintPo.lifnr) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<InPrintPo>(application, EntitySets.inPRINTPOSet, InPrintPo.lifnr, navigationPropertyName, entityData)
    }
}
